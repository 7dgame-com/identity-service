...
const IDENTITY_SUBJECT_IDS_QUERY =
  "SELECT legacy_user_id AS subject_id FROM identity_users WHERE legacy_user_id IS NOT NULL AND source = 'legacy-shadow' AND status = 'active' ORDER BY legacy_user_id ASC";
