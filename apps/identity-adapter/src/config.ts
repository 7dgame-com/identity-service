...
export const configSchema = z.object({
  ...
  accountLifecycle: z.object({
    ...
    wechatProxyBaseUrl: optionalStringFromEnv,
...
export function loadConfig(env: NodeJS.ProcessEnv = process.env): IdentityConfig {
  return configSchema.parse({
    ...
    iam: {
      ...
      profileWriteLegacyApiBaseUrl:
        env.IDENTITY_IAM_PROFILE_WRITE_LEGACY_API_BASE_URL ?? env.IDENTITY_ACCOUNT_LIFECYCLE_LEGACY_API_BASE_URL,
      profileWriteTimeoutMs:
        env.IDENTITY_IAM_PROFILE_WRITE_TIMEOUT_MS ?? env.IDENTITY_ACCOUNT_LIFECYCLE_TIMEOUT_MS,
      profileWriteDualWriteExecutionEnabled: env.IDENTITY_IAM_PROFILE_WRITE_DUAL_WRITE_EXECUTION_ENABLED,
      profileWriteRolloutMode: env.IDENTITY_IAM_PROFILE_WRITE_ROLLOUT_MODE,
    ...
    accountLifecycle: {
      ...
      wechatProxyBaseUrl: env.IDENTITY_WECHAT_PROXY_BASE_URL,
